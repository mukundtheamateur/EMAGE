...
def agerec():
	def detect_and_predict_age(frame, faceNet, ageNet, minConf=0.5):
		...
		AGE_BUCKETS = ["0_2", "4_6", "8_12", "15_20", "25_32",
			"38_43", "48_53", "60_100"]
	...
	agedete = keymax
	filee = open('age_detail.txt','a') 
	filee. truncate(0)

	filee.write(agedete)
	filee.close()

	filee = open('age_detail.txt','r')
